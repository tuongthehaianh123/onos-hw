...
import (
	...
	"github.com/tuongthehaianh123/onos-hw/pkg/rnib"

	e2api "github.com/onosproject/onos-api/go/onos/e2t/e2/v1beta1"
	"github.com/tuongthehaianh123/onos-hw/pkg/store/actions"

	topoapi "github.com/onosproject/onos-api/go/onos/topo"

	appConfig "github.com/tuongthehaianh123/onos-hw/pkg/config"

	measurmentStore "github.com/tuongthehaianh123/onos-hw/pkg/store/measurements"
	...
	"github.com/tuongthehaianh123/onos-hw/pkg/broker"
)
...
func (m *Monitor) processIndicationFormat1(ctx context.Context, indication e2api.Indication,
	...
	//Receive indication
	log.Infof("Received indication header format 1 %v:", indHeader.GetIndicationHeaderFormat1())
	log.Infof("Received indication message format 1: %v", indMessage.GetIndicationMessageFormat1())
